 ...
 *
 * Two leaves grew their own copy of this before it was hoisted here.
 */
...
/// A node nothing else is spinning, for the duration of one call sequence.
...
/// Base for leaves that complete within one tick. Holds the tree's node for logging; the calls
/// themselves use makeClientNode().
